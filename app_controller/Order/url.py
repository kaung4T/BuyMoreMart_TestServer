...
urlpatterns = [
    ...
    path('order_success/<str:order_id>/', order_complete.Order_end().success, name='order_success'),
    path('order_fail/<str:order_id>/', order_complete.Order_end().fail, name='order_fail'),
